...
export const en = {
  ...
  'profiles.modules': 'Modules and Permissions',
  'profiles.modulesList': 'Assigned Modules',
  'profiles.menusList': 'Assigned Menus',
  'profiles.noModules': 'No modules assigned',
  'profiles.noMenus': 'No menus assigned',
  'profiles.moduleRequired': 'At least one module or permission must be selected',
  'profiles.confirmDeleteMultiple': 'Are you sure you want to delete the selected profiles?',
  'profiles.viewDetails': 'Profile Details',
  ...
  'users.filterByProfile': 'Filter by profile',
  'users.allStatuses': 'All statuses',
  'users.allProfiles': 'All profiles',
  'users.deleteSelected': 'Delete selected',
  'users.cancelSelection': 'Cancel selection',
  ...
  'users.statusCONFIRMED': 'Confirmed',
  ...
  'users.deleteConfirmMessage': 'Are you sure you want to delete the user',
  'users.deleteWarning': 'This action cannot be undone. All data associated with this user will be permanently removed.',
  'users.block': 'Block',
  'users.unblock': 'Unblock',
  'users.createFirst': 'Create your first user',
  'users.noUsersFound': 'No users found',
  'users.tryDifferentFilters': 'Try using different filters or create a new user',
